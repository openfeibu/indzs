<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:77:"/home/vagrant/Code/independent/app/admin/view/enrollment/enrollment_edit.html";i:1511928509;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/Enrollment/enrollment_runedit'); ?>">
						...
						<div class="col-sm-10">
							<select name="recruit_major_id" class="col-sm-4 selector" required>
								...
								<?php if(is_array($recruit_major_list) || $recruit_major_list instanceof \think\Collection || $recruit_major_list instanceof \think\Paginator): if( count($recruit_major_list)==0 ) : echo "" ;else: foreach($recruit_major_list as $key=>$v): ?>
									<option value='<?php echo $v['recruit_major_id']; ?>' <?php if($v['recruit_major_id'] == $enrollment['recruit_major_id']): ?>selected<?php endif; ?>><?php echo $v['recruit_major_name']; ?></option>
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 面向招生： </label>

						<div class="col-sm-10">
							<select name="school_type" class="col-sm-4 selector"  style='width:20%;margin-right:10px;' required disabled>
								<?php if(is_array($school_types) || $school_types instanceof \think\Collection || $school_types instanceof \think\Paginator): if( count($school_types)==0 ) : echo "" ;else: foreach($school_types as $k=>$v): ?>
									<option value='<?php echo $k; ?>' <?php if($k == $enrollment['school_type']): ?>selected<?php endif; ?>><?php echo $v; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="enrollment_number" value="<?php echo $enrollment['enrollment_number']; ?>" required/>
						</div>
					</div>
					<div class="space-4"></div>
