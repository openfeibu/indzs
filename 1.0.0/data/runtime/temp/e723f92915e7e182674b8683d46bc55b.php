<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"/home/vagrant/Code/independent/app/home/view/default/index.html";i:1511012922;s:69:"/home/vagrant/Code/independent/app/home/view/default/public/head.html";i:1511012920;s:73:"/home/vagrant/Code/independent/app/home/view/default/public/function.html";i:1511012920;s:71:"/home/vagrant/Code/independent/app/home/view/default/public/config.html";i:1511012920;s:71:"/home/vagrant/Code/independent/app/home/view/default/public/footer.html";i:1511012920;}*/ ?>
<?php 
/*这里只是一个模板函数库演示*/
function helloworld(){
	echo "hello YFCMF!";
        ...
        <div class="login">
            ...
            <form action="<?php echo url('home/Login/runlogin'); ?>" method="post">
                ...
                <div class="input-item">
                     ...
                     <div class="code">
                       <img src="<?php echo url('home/Login/verify'); ?>"  onClick="this.src='<?php echo url('home/Login/verify'); ?>'+'?'+Math.random()" class="verify" >
                     </div>
    ...
    $.post("<?php echo url('home/Login/runlogin'); ?>",form,function(data){
        if(data.code == 1){
          ...
          window.location.href = '<?php echo url('home/center/index'); ?>';
            ...
            $(".verify").attr('src',"<?php echo url('home/Login/verify'); ?>"+'?'+Math.random())
            alert(data.msg);
        }
