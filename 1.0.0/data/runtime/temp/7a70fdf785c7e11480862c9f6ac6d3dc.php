<?php if (!defined('THINK_PATH')) exit(); /*a:7:{s:74:"/home/vagrant/Code/independent/app/admin/view/examination/member_list.html";i:1511976952;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:79:"/home/vagrant/Code/independent/app/admin/view/examination/ajax_member_list.html";i:1511969491;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<form name="admin_list_sea" class="form-search" id="list-filter" method="post" action="<?php echo url('admin/Examination/member_list'); ?>">
				<div class="col-xs-12 col-sm-4  margintop5">
					按考场筛选：
					<select name="room_id" class="ajax_change">
						<option value="">所有</option>
						<?php if(is_array($rooms) || $rooms instanceof \think\Collection || $rooms instanceof \think\Paginator): if( count($rooms)==0 ) : echo "" ;else: foreach($rooms as $k=>$room): ?>
				...
				<div class="col-xs-4 col-sm-3 margintop5">
					<div class="input-group-btn">
						<a href="<?php echo url('admin/Examination/member_export'); ?>" title="导出"  class="export_btn">
							<span class="export_span">导出：</span><i class="fa fa-download export"></i>
						</a>
					</div>
				</div>
			</form>
    ...
    <tr>
        ...
        <td><?php echo $v['GexamineeNumber']; ?></td>
    </tr>
<?php endforeach; endif; else: echo "" ;endif; else: ?>
    <tr>
