<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:78:"/home/vagrant/Code/independent/app/admin/view/admin/university_admin_list.html";i:1511928734;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/Admin/university_admin_add'); ?>">
			...
			<div class="col-xs-10 col-sm-5 margintop5">
				<form name="admin_list_sea" class="form-search" method="post" action="<?php echo url('admin/Admin/university_admin_list'); ?>">
			...
			<div class="col-xs-4 col-sm-5 margintop5">
				<div class="input-group-btn">
					<a href="<?php echo url('admin/Admin/university_admin_list'); ?>">
				...
				<div class="input-group-btn">
					<a href="<?php echo url('admin/Admin/university_admin_export'); ?>" title="导出所有高职负责人">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('/admin/Admin/admin_delall'); ?>" >
						<input type="hidden" name="checkk" id="checkk" value="1" /><!--用于判断操作类型-->
						<input type="hidden" name="return_url"  value="<?php echo url('/admin/Admin/university_admin_list',['p' => input('p',1)]); ?>" />
							...
							<?php if(is_array($admin_list) || $admin_list instanceof \think\Collection || $admin_list instanceof \think\Paginator): if( count($admin_list)==0 ) : echo "" ;else: foreach($admin_list as $key=>$v): ?>
								<tr>
									<td class="hidden-xs" height="28" >
							            <label class="pos-rel">
							                <input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['admin_id']; ?>">
							                <span class="lbl"></span>
							            </label><?php echo $v['admin_id']; ?>
							        </td>
									...
									<td>
										<div class="hidden-sm hidden-xs action-buttons">
											<a class="green" href="<?php echo url('admin/Admin/university_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" title="修改">
												<i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
											<?php if($v['admin_id'] != 1): ?>
												<a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/Admin/university_admin_del',array('admin_id'=>$v['admin_id'])); ?>" title="删除">
										...
										<div class="hidden-md hidden-lg">
											<div class="inline position-relative">
												...
												<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
													<li>
														<a href="<?php echo url('admin/Admin/university_admin_edit',array('admin_id'=>$v['admin_id'])); ?>" class="tooltip-success" data-rel="tooltip" title="" data-original-title="修改">
																	<span class="green">
													...
													<?php if($v['admin_id'] != 1): ?>
														<li>
															<a href="<?php echo url('admin/Admin/university_admin_del',array('admin_id'=>$v['admin_id'])); ?>"  data-info="你确定要删除吗？" class="tooltip-error confirm-rst-url-btn" data-rel="tooltip" title="" data-original-title="删除">
																	<span class="red">
