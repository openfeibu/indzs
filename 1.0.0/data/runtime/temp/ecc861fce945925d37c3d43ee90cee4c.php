<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"/home/vagrant/Code/independent/app/admin/view/enrollment/enrollment.html";i:1512006560;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1512006594;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1512006594;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1512006594;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
	<meta charset="utf-8" />
	<title>自主招生管理系统</title>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/Enrollment/enrollment_add'); ?>">
			...
			<!-- <div class="col-xs-10 col-sm-10  margintop5">
				<a href="<?php echo url('admin/Enrollment/export_enrollment'); ?>"><i class="fa fa-download export"></i></a>
			</div> -->
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form class="ajaxForm" id="alldel" name="alldel" method="post" action="<?php echo url('admin/enrollment/enrollment_delall'); ?>">
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tbody id="ajax-data">
							<?php if(!empty($enrollments)): if(is_array($enrollments) || $enrollments instanceof \think\Collection || $enrollments instanceof \think\Paginator): if( count($enrollments)==0 ) : echo "" ;else: foreach($enrollments as $key=>$v): ?>
								<tr>
									<td class="hidden-xs" height="28" >
										<label class="pos-rel">
											<input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['enrollment_id']; ?>">
											<span class="lbl"></span>
										</label><?php echo $v['enrollment_id']; ?>
									</td>
									<td><?php echo $v['recruit_major_name']; ?></td>
									<td><?php echo $v['recruit_major_code']; ?></td>
									<td><?php echo $v['school_type']; ?></td>
									<td><?php echo $v['enrollment_number']; ?></td>
									<td>
							            <div class="hidden-sm hidden-xs action-buttons">
							                <a class="green" href="<?php echo url('admin/Enrollment/enrollment_edit',array('enrollment_id'=>$v['enrollment_id'])); ?>" title="修改">
							                    <i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
							                    <a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/Enrollment/enrollment_del',array('enrollment_id'=>$v['enrollment_id'])); ?>" title="删除">
	...
	<div class="footer-inner">
		<div class="footer-content">
			<span class="bigger-120">
				<!-- <span class="blue bolder">自主</span> -->
				自主招生管理系统 &copy; 2015-<?php echo date('Y'); ?>
			</span>
		</div>
	</div>
</div>
