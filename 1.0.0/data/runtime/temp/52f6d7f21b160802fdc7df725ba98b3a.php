...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/School/major_runedit'); ?>">
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="major_name" value="<?php echo $major['major_name']; ?>" required/>
						</div>
					</div>
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 中职专业代码： </label>
						<div class="col-sm-10">
							<input type="text" name="major_code" value="<?php echo $major['major_code']; ?>" required/>
						</div>
					</div>
					<div class="space-4"></div>
