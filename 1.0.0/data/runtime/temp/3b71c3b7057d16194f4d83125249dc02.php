<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"/home/vagrant/Code/independent/app/admin/view/school/secondary_vocat_major_list.html";i:1511939606;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
				...
				<div>
					<form id="score_form" name="leftnav" method="post" action="<?php echo url('admin/Score/score_active'); ?>" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<tbody >
                                <?php if(is_array($subjects) || $subjects instanceof \think\Collection || $subjects instanceof \think\Paginator): if( count($subjects)==0 ) : echo "" ;else: foreach($subjects as $key=>$v): ?>
                                <tr>
                                    <td height="28" ><?php echo $v['school_type_name']; ?></td>
                                    <td><?php echo $v['subjects_desc']; ?></td>
                                    <td>
                            			<div class="hidden-sm hidden-xs action-buttons">
                            				<a class="green"  href="<?php echo url('admin/school/secondary_vocat_major_edit',array('id'=>$v['id'])); ?>" title="修改">
