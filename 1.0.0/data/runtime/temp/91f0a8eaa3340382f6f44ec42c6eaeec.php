<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:68:"/home/vagrant/Code/independent/app/admin/view/examination/rooms.html";i:1511959804;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	...
	<div class="page-content">
		...
		<div class="row maintop">
			<div class="col-xs-4 col-sm-2 margintop5">
				<a href="<?php echo url('admin/Examination/room_add'); ?>">
            ...
            <div class="col-xs-4 col-sm-2 margintop5">
				<a href="javascript:;" class="generate" url="<?php echo url('admin/Examination/generate'); ?>">
			...
			<div class="col-xs-12">
				<div>
					...
					<table class="table table-striped table-bordered table-hover" id="dynamic-table">
						...
						<tbody id="ajax-data">
                            <?php if(!empty($rooms)): if(is_array($rooms) || $rooms instanceof \think\Collection || $rooms instanceof \think\Paginator): if( count($rooms)==0 ) : echo "" ;else: foreach($rooms as $key=>$v): ?>
                                <tr>
                                    <td class="hidden-xs" height="28" >
                                        <label class="pos-rel">
                                            <input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['room_id']; ?>">
                                            <span class="lbl"></span>
                                        </label><?php echo $v['room_id']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="hidden-sm hidden-xs action-buttons">
                                            <a class="green" href="<?php echo url('admin/Examination/room_edit',array('room_id'=>$v['room_id'])); ?>" title="修改">
                                                <i class="ace-icon fa fa-pencil bigger-130"></i>																</a>
                                                <a class="red confirm-rst-url-btn" data-info="你确定要删除吗？" href="<?php echo url('admin/Examination/room_del',array('room_id'=>$v['room_id'])); ?>" title="删除">
