<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:66:"/home/vagrant/Code/independent/app/admin/view/score/score_add.html";i:1511012884;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="page-content">
	...
	<div class="row">
	    <div class="col-xs-12">
                <form class="form-horizontal ajaxForm" name="score_edit" method="post" action="<?php echo url('admin/Score/score_runadd'); ?>">
			<input type="hidden" name="member_list_id" value="<?php echo $member_list_edit['member_list_id']; ?>"/>
			<?php if($major_score): if(is_array($major_score) || $major_score instanceof \think\Collection || $major_score instanceof \think\Paginator): if( count($major_score)==0 ) : echo "" ;else: foreach($major_score as $k=>$v): ?>
			<div class="form-group">
				<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> <?php echo $v; ?>: </label>
				<div class="col-sm-10">
					<input type="text" name="score[]" value="<?php if(isset($major_score_val) and isset($major_score_val[$k])): ?><?php echo $major_score_val[$k]; endif; ?>" class="col-xs-10 col-sm-4" required/>
				</div>
			</div>
			...
			<?php else: ?>
			<div class="form-group">
				<p style="text-align:center">请先录入基础理论科目</div>
			</div>
			<?php endif; ?>
		</form>
            </div>
