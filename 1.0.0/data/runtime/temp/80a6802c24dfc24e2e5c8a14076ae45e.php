<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"/home/vagrant/Code/independent/app/admin/view/school/secondary_vocat_major_edit.html";i:1511942890;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="major_list_add" method="post" action="<?php echo url('admin/School/secondary_vocat_major_runedit'); ?>">
					<input type="hidden" name='id' value="<?php echo $subject['id']; ?>">
					<?php if($subjects): if(is_array($subjects) || $subjects instanceof \think\Collection || $subjects instanceof \think\Paginator): if( count($subjects)==0 ) : echo "" ;else: foreach($subjects as $k=>$v): ?>
					<div class="form-group major_score_group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 考试科目<?php echo $k+1; ?>： </label>
						<div class="col-sm-10">
							<input type="text" name="subject[]" value="<?php echo $v; ?>" />
						</div>
					</div>
					<?php endforeach; endif; else: echo "" ;endif; else: ?>
					<div class="form-group major_score_group">
