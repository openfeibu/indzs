			...
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm2" name="excel_runimport" method="post" action="<?php echo url('admin/Member/member_runimport'); ?>"  enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 请选择学校及中职专业： </label>
						<div class="col-sm-4">
							...
							<select name="major_list"  class="col-sm-5" id="major" required>
