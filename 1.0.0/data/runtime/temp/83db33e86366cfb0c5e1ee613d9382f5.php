<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"/home/vagrant/Code/independent/app/admin/view/school/recruit_major_list.html";i:1511928734;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row maintop">
			...
			<div class="col-xs-4 col-sm-5 margintop5">
				<div class="input-group-btn">
					<a href="<?php echo url('admin/School/recruit_major_list'); ?>">
		...
		<div class="row">
			<div class="col-xs-12">
				<div>
					<form id="leftnav" class="ajaxForm" name="leftnav" method="post" action="<?php echo url('/admin/school/recruit_major_delall'); ?>" >
						...
						<table class="table table-striped table-bordered table-hover" id="dynamic-table">
							...
							<?php if(is_array($major_list) || $major_list instanceof \think\Collection || $major_list instanceof \think\Paginator): if( count($major_list)==0 ) : echo "" ;else: foreach($major_list as $key=>$v): ?>
								<tr>
									<td class="hidden-xs" height="28" >
							            <label class="pos-rel">
							                <input name="n_id[]" id="navid" class="ace" type="checkbox" value="<?php echo $v['recruit_major_id']; ?>">
							                <span class="lbl"></span>
							            </label><?php echo $v['recruit_major_id']; ?>
							        </td>
									<td height="28" ><?php echo $v['recruit_major_name']; ?></td>
									<td><?php echo $v['recruit_major_code']; ?></td>
									<!-- <td><?php echo $v['min_score']; ?></td> -->
									<td>
							...
							<tr>
								...
								<td height="50" colspan="10" align="center"><?php echo $page; ?></td>
							</tr>
						</table>
					</form>
				</div>
