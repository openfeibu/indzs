<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:76:"/home/vagrant/Code/independent/app/admin/view/enrollment/enrollment_add.html";i:1511942789;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/Enrollment/enrollment_runadd'); ?>">
						...
						<div class="col-sm-10">
							<select name="recruit_major_id" class="col-sm-4 selector" required>
								<?php if(is_array($recruit_major_list) || $recruit_major_list instanceof \think\Collection || $recruit_major_list instanceof \think\Paginator): if( count($recruit_major_list)==0 ) : echo "" ;else: foreach($recruit_major_list as $key=>$v): ?>
									<option value='<?php echo $v['recruit_major_id']; ?>'><?php echo $v['recruit_major_name']; ?></option>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<select name="school_type" class="col-sm-4 selector"  style='width:20%;margin-right:10px;' required>
					...
					<div class="form-group">
						...
						<div class="col-sm-10">
							<input type="text" name="enrollment_number" value="" required/>
						</div>
					</div>
					<div class="space-4"></div>
