<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:75:"/home/vagrant/Code/independent/app/admin/view/school/recruit_major_add.html";i:1511012885;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/School/recruit_major_runadd'); ?>">
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 高职专业名称： </label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 高职专业代码： </label>
						<div class="col-sm-10">
							<input type="text" name="recruit_major_code" value="" />
						</div>
					</div>
					<div class="space-4"></div>
					<!-- <div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 技能分线： </label>
						<div class="col-sm-10">
