<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:72:"/home/vagrant/Code/independent/app/admin/view/examination/room_edit.html";i:1511947398;s:62:"/home/vagrant/Code/independent/app/admin/view/public/base.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/header.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/left_nav.html";i:1511012885;s:66:"/home/vagrant/Code/independent/app/admin/view/public/head_nav.html";i:1511012885;s:64:"/home/vagrant/Code/independent/app/admin/view/public/footer.html";i:1511012885;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<div class="main-container" id="main-container">
	...
	<div class="page-content">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal ajaxForm" name="school_list_add" method="post" action="<?php echo url('admin/Examination/room_runedit'); ?>">
                    <input type="hidden" name="room_id" value="<?php echo $room['room_id']; ?>"/>
                    <div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 考场名称 </label>
						<div class="col-sm-10">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 招生专业： </label>
						<div class="col-sm-10">
							<select name="recruit_major_id" class="col-sm-4 selector" required>
								<?php if(is_array($recruit_major_list) || $recruit_major_list instanceof \think\Collection || $recruit_major_list instanceof \think\Paginator): if( count($recruit_major_list)==0 ) : echo "" ;else: foreach($recruit_major_list as $key=>$v): ?>
									<option value='<?php echo $v['recruit_major_id']; ?>' {if $v['recruit_major_id'] == $room['recruit_major_id']}><?php echo $v['recruit_major_name']; ?></option>
								<?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
						</div>
					</div>
                    <div class="space-4"></div>
                    <div class="form-group major_score_group">
						<label class="col-sm-2 control-label no-padding-right" for="form-field-1"> 考试科目： </label>
						<div class="col-sm-10">
                            <select name="subject[]"  class="col-sm-5 subject_more" style="width:20%;" id="major" required>
                            ...
                            <i class="hanle_room_subject_count fa fa-plus-circle"></i>
							<i class="hanle_room_subject_count fa fa-minus-circle"></i>
						</div>
					</div>
					<div class="space-4"></div>
